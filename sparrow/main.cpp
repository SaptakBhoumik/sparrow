...
#include "quickjs_libc/quickjs_libc.hpp"
        ...
        if (c == '%') {
            ...
            if (*fmt == 'p') {
                ...
                if (ptr == NULL) {
                    ...
                    printf("H%+06lld.%zd",
                           js_trace_malloc_ptr_offset(ptr, (trace_malloc_data*)s->opaque),
...
#define PROG_NAME "sparrow"

void help(void)
{
    printf("Note it is a WIP project.\n"
           "Sparrow version " CONFIG_VERSION "\n"
